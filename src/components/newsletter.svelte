<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Vil du få nyheter om juletrær?</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
        Få den siste informasjonen om juletretrender rett i din epostkasse, helt gratis. Bare gi oss dine personlige data i dette skjemaet, så sender vi deg nyhetsbrevene våre og lover å ikke selge informasjonen din videre til spammere. 
      </p>
    </div>
    <div class="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end">
      <div class="relative flex-grow w-full">
        <label for="full-name" class="leading-7 text-sm text-gray-600">Navn</label>
      ...
      <div class="relative flex-grow w-full">
        <label for="email" class="leading-7 text-sm text-gray-600">Epost</label>
